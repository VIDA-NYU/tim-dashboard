...
export function MemoryCanvas(props) {
    ...
    return (
        <ContentContainer ref={container} className="content-container">
            ...
            <div style={{ position: 'absolute', top: 0, left: 0, width: "80%", height: '100%', overflow: 'hidden' }} ref={domContent} />
            ...
            <Canvas
                ...
                <OrthographicCamera makeDefault={true} far={10000000} near={-1000000} position={[-500, 1000, 1000]} zoom={0.05} />
